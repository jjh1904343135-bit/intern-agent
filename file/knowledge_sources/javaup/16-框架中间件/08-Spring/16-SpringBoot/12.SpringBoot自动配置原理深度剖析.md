---
slug: /framework/spring/springboot-auto-configuration
description: "@EnableAutoConfiguration原理;spring.factories/AutoConfiguration.imports;@Conditional条件装配;AutoConfigurationImportSelector;自动配置加载流程;Debug调试自动配置。"
keywords: ["@EnableAutoConfiguration", "spring.factories", "AutoConfigurationImportSelector", "自动配置原理", "@Conditional"]
---
