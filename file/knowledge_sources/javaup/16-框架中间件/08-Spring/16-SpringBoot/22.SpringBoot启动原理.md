...
description: "SpringApplication初始化流程;spring.factories SPI加载机制;ApplicationContextInitializer/ApplicationListener;run方法执行步骤;Environment环境装配;refresh刷新上下文;内嵌Tomcat启动;LaunchedURLClassLoader打破双亲委派;Fat JAR类加载机制。"
keywords: ["SpringApplication", "spring.factories", "refresh刷新", "Tomcat启动", "LaunchedURLClassLoader"]
---
