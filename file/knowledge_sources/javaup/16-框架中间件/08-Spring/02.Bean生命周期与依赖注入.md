...
description: "Bean五个生命周期阶段:实例化/初始化/注册/使用/销毁;@PostConstruct与@PreDestroy;BeanPostProcessor后置处理;Aware接口回调;InitializingBean与DisposableBean;作用域singleton/prototype。"
keywords: ["Bean生命周期", "@PostConstruct", "BeanPostProcessor", "Aware", "作用域"]
---
