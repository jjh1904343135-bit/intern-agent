---
slug: /framework/spring/transaction-failure
description: "事务失效常见场景总结;自调用导致事务失效;private方法事务不生效;异常被吃掉不回滚;多线程事务问题;AspectJ模式解决自调用。"
keywords: ["事务失效", "自调用", "private方法", "异常处理", "AspectJ"]
---
