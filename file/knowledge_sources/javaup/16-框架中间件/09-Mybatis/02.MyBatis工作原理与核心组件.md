---
slug: /framework/mybatis/working-principle
description: "启动阶段配置解析与运行阶段执行;JDK动态代理生成Mapper实现;SqlSession四大核心对象;Executor执行器StatementHandler参数处理;MapperProxy代理机制;spring.factories加载流程。"
keywords: ["MapperProxy", "SqlSession", "Executor执行器", "StatementHandler", "动态代理"]
---
