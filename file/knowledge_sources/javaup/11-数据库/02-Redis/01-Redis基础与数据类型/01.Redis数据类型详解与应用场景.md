...
description: "String/Hash/List/Set/ZSet五种基础类型;缓存/计数器/分布式锁场景;Bitmap位图与HyperLogLog基数统计;GEO地理位置查询;Stream消息流;每种类型应用实战案例。"
keywords: ["Redis数据类型", "String", "ZSet", "HyperLogLog", "Redis Stream"]
---
