...
description: "MVCC多版本并发控制实现原理;Undo Log版本链结构;ReadView可见性判断规则;trx_id/min_trx_id/max_trx_id字段含义;RC与RR的ReadView生成时机差异;Next-Key Lock间隙锁。"
keywords: ["MVCC", "ReadView", "版本链", "快照读", "Next-Key Lock"]
---
