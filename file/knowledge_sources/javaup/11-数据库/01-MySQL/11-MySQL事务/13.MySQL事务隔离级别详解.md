...
description: "脏读/不可重复读/幻读三种并发问题;四种隔离级别(READ UNCOMMITTED/READ COMMITTED/REPEATABLE READ/SERIALIZABLE);InnoDB默认RR级别;快照读与当前读区别。"
keywords: ["脏读", "不可重复读", "幻读", "隔离级别", "REPEATABLE READ"]
---
